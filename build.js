#!/usr/bin/env node
/**
 * Build script for The Lighthouse Keeper
 * Combines all source files into a single distributable HTML file
 */
...
// Read all JS files in order (dependencies first)
const jsFiles = [
...
jsFiles.forEach(file => {
  ...
  if (fs.existsSync(filePath)) {
    combinedJS += `// === ${file} ===\n`;
    // Remove module.exports lines for browser compatibility
...
const outputPath = path.join(distDir, 'lighthouse.html');
